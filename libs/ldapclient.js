...
const fs     = require("fs");
const ldapURL = [ 'ldap://172.20.1.10:389' ];  // Array can contain additional LDAP servers to try.
//const bindDN = 'uid=jtordoya,dc=PragmaInvest,dc=com';
const bindDN = 'jtordoya@pragmainvest.com';
const bindPassword = 'Facil123';
const baseDN = 'DC=PragmaInvest,DC=com';
const usernameAttribute = 'sAMAccountName';
const filter = '(objectClass=person)';
//(&(objectClass=computer)(cn=jtord*))

var username = 'jtordoya';
